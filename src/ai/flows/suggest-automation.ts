...
const SuggestAutomationOutputSchema = z.object({
  suggestedService: z
    .string()
    .describe(
      'The most relevant service automation suggested to address the user\'s content bottlenecks. Must be one of the following: Leads Hunter Agent, Follow-Up Agent, Support Agent, Operations Agent, Data Command Agent, Custom AI Agent.'
    ),
  reasoning: z
    .string()
...
- Custom AI Agent: Your specific bottleneck, solved.
