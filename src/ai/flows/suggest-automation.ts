...
const SuggestAutomationOutputSchema = z.object({
  suggestedService: z
    .string()
    .describe(
      'The most relevant service automation suggested to address the user\'s content bottlenecks. Must be one of the following: Search-Intent Lead Scraper, Repurposing Engine, Invoice Collector, Long-form Generator, Smart Inbox Categorizer.'
    ),
  reasoning: z
    .string()
...
- Smart Inbox Categorizer: Inbox zero, automated
