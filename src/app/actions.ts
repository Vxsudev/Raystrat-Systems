    ...
    try {
        ...
        const msg = {
            ...
            html: `
                ...
                <p><a href="https://raystratsystems.com/systems/${agentSlug}">View the ${agentName} Page</a></p>
  ...
  try {
    ...
    const userEmailHtml = `
      ...
      <div class="container">
        ...
        ` : `
          <p style="margin-top: 20px;">If you'd like to discuss how our systems can address your specific bottlenecks, you can book a free 15-minute audit with our team here:</p>
          <a href="https://calendly.com/raystrat/15-min-audit" class="cta-button">Book Your Free Audit</a>
        `}
        <div class="footer">
