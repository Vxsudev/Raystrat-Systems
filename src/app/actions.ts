...
export async function downloadPlaybookAction(
    ...
    if (!process.env.SENDGRID_API_KEY || !process.env.SENDGRID_FROM_EMAIL) {
        ...
        // We don't return an error to the user, as lead capture is the primary goal.
        // The email is secondary. We'll just log the error on the server.
    ...
    try {
        ...
        // Don't return an error to the user here either.
        // We will rely on server logs to debug email sending issues.
    }
